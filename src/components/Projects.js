...
function Projects() {
  ...
  const projects = [
...

    {
      ...
      description: 'Amélioration du référencement et de la performance du site d’une photographe professionnelle',
      fullDescription: 'Mis en œuvre des stratégies d’optimisation SEO pour le site de Nina Carducci. L’audit initial a révélé des opportunités d’amélioration de la vitesse de chargement et de l’accessibilité. J’ai optimisé les images, révisé le code pour la performance et l’accessibilité, et fourni un rapport détaillé des améliorations apportées, résultant en une amélioration significative des scores Lighthouse et Wave.',
      skills: ['SEO'],
      images: [
        '../../image/seo_before.webp', 
        '../../image/seo_after.webp', 
      ],
    },
  ];
